...
4. [**Bidirectional Search**](/search/graph-tree-search/bidirectional-search/README.md): Simultaneously searches forward from start and backward from goal, meeting in the middle.
